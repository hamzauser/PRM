 ...
 *
 */
public class Client200 implements MessageListener {
	...
	public static void main(String[] args) throws NamingException, JMSException, IOException {
		...
		Client200 client200 = new Client200();

		Context context = Client200.getInitialContext();
		...
		jmsContext.createConsumer(queue03).setMessageListener(client200);
		...
		while (true) {
			// nettoyer la console
			System.out.println("#res pour saisir resultat");
			...
			if (messageToSend.equalsIgnoreCase("exit")) {
				...
				System.exit(0);
			} else if (messageToSend.contains("#res")){
				// si commande #res saisir resultat
				saisirResultat();
			}	
		}
	}
